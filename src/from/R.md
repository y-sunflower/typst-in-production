...
In R, the recommended binding to use is [r2typ](https://github.com/y-sunflower/r2typ), maintained by the same maintainer as Typst in Production (e.g., the website you're currently in).
...
Pretty much all Typst functions, colors, direction, etc, are supported here.
